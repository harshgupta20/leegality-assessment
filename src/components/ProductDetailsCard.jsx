...
const ProductDetailsCard = ({ productId, productThumbnail, productTitle, productPrice }) => {
    return (
        <div key={productId} className='border border-gray-300 rounded-md p-4 hover:transform hover:scale-102 transition-transform duration-300 hover:bg-blue-50 cursor-pointer'>
